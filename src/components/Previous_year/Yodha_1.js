...
import PYQ from './pyq'
import "./pyq_1.css"
import { penpaper, pyodha_1 } from '../images'
import Navbar from '../Navbar'
import Footer from '../footer'

export default function Yodha_1() {
  return (
    <>
    <Navbar/>
    <br/>
    ...
    <div  className="column1BrahamastraBox col-sm-12 col-lg-6">
      <h1 className="brahamastra">YODHA 1</h1>
    ...
    <div className='col-sm-12 col-lg-6'>
      <PYQ
        courseObjective="JEE (MAINS+ADVANCED) 2024 targeted test series "
        target=" JEE-2024"
        recomended=" Dropper students targetting Jee-Advanced 2024"
