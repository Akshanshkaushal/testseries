...
import PYQ from './pyq'
import "./pyq_1.css"
import { penpaper, samarpan_2 } from '../images'
import Navbar from '../Navbar'
import Footer from '../footer'

export default function Samparan_2() {
  return (
    <>
    <Navbar/>
    <br/>
    ...
    <div  className="column1BrahamastraBox col-sm-12 col-lg-6">
      <h1 className="brahamastra">SAMARPAN 2</h1>
    ...
    <div className='col-sm-12 col-lg-6'>
      ...
      <PYQ
        ...
        listno1="28 Tests (20 topic wise tests + 8 cumulative tests) conducted at regular intervals as per the latest exam pattern. "
