...
import PYQ from './pyq'
import "./pyq_1.css"
import { penpaper, psarthi_1 } from '../images'
import Footer from '../footer'
import Navbar from '../Navbar'

export default function Sarthi_1() {
  return (
    <>
    <Navbar/>
    <br/>
    ...
    <div  className="column1BrahamastraBox col-sm-12 col-lg-6">
      <h1 className="brahamastra"> SARTHI 1</h1>
    ...
    <div className='col-sm-12 col-lg-6'>
      ...
      <PYQ
        ...
        active=" JEE ADVANCED 2025"
        mode="Online"
        medium="English"

        listno1=" 52 Tests (32 topic wise tests + 20 cumulative tests) conducted at regular intervals as per the latest exam pattern."
